...
Navigate to [Swagger contract testing](https://kiro.dev/launch/powers/add?name=swagger-contract-testing) in your browser and that will install it in your kiro IDE.
